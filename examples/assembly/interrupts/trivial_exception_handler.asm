...
csrrw zero, mtvec, t0 # escribimos la direccion del handler en utvc
...
csrrw zero, mepc, t0 # Excribimos el pc de nuevo en uepc
mret # finalizamos el handler, escribiendo el uepc en el pc
